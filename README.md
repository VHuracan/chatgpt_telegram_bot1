...
Пресеты маркетолога, копирайтера, бизнескоуча, психолога и многое другое.
Для пользователей есть ограничение на дневное количество сообщений, 
поддерживается автоматическая оплата пользователем расширенной подписки, монетизация за счет платной подписки через Юкасса.
